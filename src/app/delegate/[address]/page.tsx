...
// dynamic and ignores revalidate — every visit would pay the delegatee
// multicalls. An empty list lets each visited address be rendered once on
// demand and then served from the ISR cache.
