...
const BRIDGES: Bridge[] = [
  ...
  },
  {
    name: 'Squid Router',
    operator: 'Squid',
    href: 'https://app.squidrouter.com/?chains=1%2C42220&tokens=0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE',
    logo: SquidLogo,
    description:
  ...
  },
  {
    name: 'Portal Bridge',
    operator: 'Wormhole',
    href: 'https://portalbridge.com/?fromChain=Ethereum&toChain=Celo',
    logo: PortalLogo,
