...
describe('decodeAndPrepareProposalEvent', () => {
  it('ignores unhandled events', () => {
    ...
    expect(decodeAndPrepareProposalEvent('WrongEvent', mockEvent)).resolves.toEqual(null);
  ...
  it('throws on malformed events', () => {
    ...
    expect(decodeAndPrepareProposalEvent('ProposalExecuted', mockEvent)).rejects
  ...
  it('processes proper events', async () => {
    ...
    expect(decodeAndPrepareProposalEvent('ProposalExecuted', mockEvent)).resolves.toBe(143n);
  });
});
