...
export type ValidatorGroupInfo = Awaited<ReturnType<typeof fetchValidatorGroupInfo>>;

export async function fetchValidatorGroupInfo(publicClient: PublicClient) {
