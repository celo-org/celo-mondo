...
CREATE TABLE IF NOT EXISTS "blocksProcessed" (
...
CREATE INDEX IF NOT EXISTS "events_blockNumber_index" ON "events" USING btree ("blockNumber" int8_ops);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "events_chainId_index" ON "events" USING btree ("chainId" int4_ops);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "events_eventName_index" ON "events" USING btree ("eventName" text_ops);--> statement-breakpoint
